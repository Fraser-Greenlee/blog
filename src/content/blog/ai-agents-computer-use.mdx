...
AGI will be a computer using agent, the computer is the highest-leverage tool known to man, so **HOW** AI agents will use computers is the question of our time.
...
from the amazing [OpenCUA](https://opencua.xlang.ai/)
