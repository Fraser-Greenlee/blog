...
I think we'll find that over 90% of the steps taken by computer using agent tasks will be done via the terminal and MCP servers. Sure GUI computer use will be present when needed but will not be here to stay long term.
